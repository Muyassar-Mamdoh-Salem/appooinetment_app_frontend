...
function Footer() {
    ...
    <div className="mx-auto max-w-md">
      ...
      <form className="mt-6">
        <div className="relative max-w-lg">
          ...
          <button
            className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-lime-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-lime-700"
          >
            Subscribe
          </button>
        </div>
  ...
  Created with ❤️ by{" "}
  <a
    href="https://my-portfolio-7ves.vercel.app/"
    target="_blank"
    rel="noopener noreferrer"
    className="text-gray-700 underline transition hover:text-gray-900"
  >
    Muyassar Mamdoh Salem
  </a>
</p>
